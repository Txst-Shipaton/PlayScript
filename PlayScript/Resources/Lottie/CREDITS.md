...
The `.json` animations in this folder are original to PlayScript. The `.lottie`
archives below package third-party animations unchanged (only minified into the
dotLottie container); colours are adjusted at runtime in `LottieLayer` call sites.

| File | Source | Author | License |
| --- | --- | --- | --- |
| `hero-heart.lottie` | [lottie-ios `Tests/Samples/TwitterHeart.json` @ 4.6.1](https://github.com/airbnb/lottie-ios/blob/4.6.1/Tests/Samples/TwitterHeart.json) | Airbnb, lottie-ios project | Apache-2.0 |
| `commit-check.lottie` | [lottie-ios `Tests/Samples/success.json` @ 4.6.1](https://github.com/airbnb/lottie-ios/blob/4.6.1/Tests/Samples/success.json) | Airbnb, lottie-ios project | Apache-2.0 |
| `ending-infinity.lottie` | [lottie-ios `Tests/Samples/LottieFiles/infinity_loader.json` @ 4.6.1](https://github.com/airbnb/lottie-ios/blob/4.6.1/Tests/Samples/LottieFiles/infinity_loader.json), originally from lottiefiles.com | LottieFiles creator (not named in the source) | Lottie Simple License (FL 9.13.21) |
| `narration-quill.lottie` | [lottie-ios `Tests/Samples/LottieFiles/draft_icon.json` @ 4.6.1](https://github.com/airbnb/lottie-ios/blob/4.6.1/Tests/Samples/LottieFiles/draft_icon.json), originally from lottiefiles.com | LottieFiles creator (not named in the source) | Lottie Simple License (FL 9.13.21) |

## Apache License 2.0

Copyright Airbnb, Inc. Licensed under the Apache License, Version 2.0:
https://www.apache.org/licenses/LICENSE-2.0 (full text in the
[lottie-ios LICENSE](https://github.com/airbnb/lottie-ios/blob/4.6.1/LICENSE)).
